...
import RecommendedProducts from "@/components/products/details/RecommendedCard";
      ...
      <div className="container px-2 md:px-6 mx-auto">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:grid-cols-[2fr_1fr] xl:gap-16">
          ...
          <div className="lg:sticky top-20 self-start mt-6 sm:mt-8 lg:mt-0 rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-800 shadow-md p-8">
            ...
            <div>
              <h4 className="text-xl font-semibold">Recommended Produced:</h4>
              <RecommendedProducts id={id} category={product.category} />
            </div>
          </div>
        </div>
      </div>
