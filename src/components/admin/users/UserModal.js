...
const UserModal = ({ title, onConfirm, show, setShow, children }) => {
  return (
    <div
      className={`${show ? "flex" : "hidden"} overflow-y-auto overflow-x-hidden bg-black/20 fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-screen`}
    >
